package liblynx.api.container;

import liblynx.api.container.slot.SlotDisabled;
import liblynx.api.container.slot.SlotSpecimen;
import liblynx.api.container.slot.SlotSpecimenLegacy;
import liblynx.api.container.slot.SlotSpecimenType;
...
public abstract class ContainerBase extends Container {
    ...
    private ItemStack getStackFromSlot(Slot slot) {
        ...
        if (stackInSlot == null) {
            if (slot instanceof SlotSpecimenType) {
